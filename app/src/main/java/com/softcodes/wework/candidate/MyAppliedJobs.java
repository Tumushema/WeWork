    ...
    public void ShowDetails(final String email) {
        ...
        class Details extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... strings) {
                ...
                return requestHandler.sendPostRequest(MY_APPLIED_JOBS, params);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        AppliedJobs_Adapter adapter = new AppliedJobs_Adapter(MyAppliedJobs.this, jobsList);
